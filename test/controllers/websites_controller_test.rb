...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { accessed: @website.accessed, site: @website.site } }, as: :json
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { accessed: @website.accessed, site: @website.site } }, as: :json
    assert_response 200
  end
