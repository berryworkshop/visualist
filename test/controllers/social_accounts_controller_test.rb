...
class SocialAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create social_account" do
    assert_difference('SocialAccount.count') do
      post social_accounts_url, params: { social_account: { account: @social_account.account, description: @social_account.description, label: @social_account.label, service: @social_account.service } }, as: :json
    end
  ...
  test "should update social_account" do
    patch social_account_url(@social_account), params: { social_account: { account: @social_account.account, description: @social_account.description, label: @social_account.label, service: @social_account.service } }, as: :json
    assert_response 200
  end
